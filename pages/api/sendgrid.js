...
async function sendEmail(req, res) {
  try {
    await sendgrid.send({
      to: "yash.thapliyal.college@gmail.com", // Your email where you'll receive emails
      from: "yash.thapliyal.college@gmail.com", // your website email address here
      subject: `[Yash's Porfolio] : ${req.body.subject}`,
